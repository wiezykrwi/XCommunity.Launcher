...
public class MainViewModel : ViewModelBase
{
    ...
    public ModViewModel? SelectedMod
    {
        ...
        set
        {
            ...
            _selectedMod.IsLoadingDetails = true;
            
            OnPropertyChanged();
            _steamService.GetModDetails(_selectedMod.Data.Id).ContinueWith(t =>
            {
                _selectedMod.SetDetails(t.Result);
                _selectedMod.IsLoadingDetails = false;
            });
        }
    }
